...
| 社名 | リポジトリ名から「株式会社電装」で仮組み | 正式社名・ロゴに差し替え |
...
| 施工写真 | ヒーローは実写真（`hero.webp`/`hero.jpg`、原本は `KabusikigaisyaDenso_Web_hero.png`）。施工事例・代表者写真はプレースホルダー | 掲載許可確認のうえ実写真へ。要マスキング項目は design.md §8 参照 |
